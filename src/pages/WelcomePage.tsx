...
function WelcomePage () {
    ...
    return (
        <div className=" font-sarabun flex flex-col items-center justify-center h-screen">
            ...
            <div className='flex flex-col space-y-3 mt-20'>
                ...
                <button className='px-5 bg-transparent text-3xl'>create a space</button>
                <button className='px-5 bg-transparent text-3xl'>about</button>
            </div>
        </div>
    );
}
